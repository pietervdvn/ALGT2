...
>>> loadAssetLangDef "TestInput/Faulty/Relations" ["TypeErr"] & toCoParsable
"| While typing rule \"not\" in TestInput/Faulty/Relations/TypeErr.language at lines 21 - 25\n| While typing \"5\" while typing in TestInput/Faulty/Relations/TypeErr.language at line 24, columns 5 - 8\n| Could not type the sequence (\"5\") as a TypeErr.bool \n  Error: \n    \8226 Unexpected literal \"5\"\n    \8226 Expected literal \"True\"\n  Error: \n    \8226 Unexpected literal \"5\"\n    \8226 Expected literal \"False\""
...
>>> import LanguageDef.API
>>> loadAssetLangDef "" ["TestInput/Faulty","FunctionTyperTest"] & toCoParsable
"| While typing the function \"f\" \n| While typing clause f.0 in /TestInput/Faulty/FunctionTyperTest.language at lines 25 - 26\n| The clause is: (f(x)\t = y) in /TestInput/Faulty/FunctionTyperTest.language at lines 25 - 26\nError: \n  \8226 The variable \"y\" was not defined\n| While typing the function \"g\" \n| While typing clause g.0 in /TestInput/Faulty/FunctionTyperTest.language at lines 28 - 29\n| The clause is: (g(x)\t = not(x)) in /TestInput/Faulty/FunctionTyperTest.language at lines 28 - 29\n| While typing the return expression of the function, namely not(x) in /TestInput/Faulty/FunctionTyperTest.language at line 28, columns 8 - 14\n| While typing not(x) while typing in /TestInput/Faulty/FunctionTyperTest.language at line 28, columns 8 - 14\nError: \n  \8226 Unexpected type of 'not(x)', namely TestInput/Faulty.FunctionTyperTest.bool\n  \8226 Use an expression which returns a TestInput/Faulty.FunctionTyperTest.int (or a subset of that type)\n| While typing the function \"h\" \n  | While typing clause h.0 in /TestInput/Faulty/FunctionTyperTest.language at lines 31 - 32\n  | The clause is: (h(x:int)\t = bool) in /TestInput/Faulty/FunctionTyperTest.language at lines 31 - 32\n  Error: \n    \8226 The variable \"bool\" was not defined\n  | While typing clause h.1 in /TestInput/Faulty/FunctionTyperTest.language at lines 32 - 33\n  | The clause is: (h(x)\t = not(x)) in /TestInput/Faulty/FunctionTyperTest.language at lines 32 - 33\n  Error: \n    \8226   The variable \"x\" is used as a TestInput/Faulty.FunctionTyperTest.bool, but could be a TestInput/Faulty.FunctionTyperTest.expr which is broader"
